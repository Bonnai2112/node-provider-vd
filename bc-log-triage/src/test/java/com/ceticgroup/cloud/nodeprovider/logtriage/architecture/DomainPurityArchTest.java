package com.ceticgroup.cloud.nodeprovider.logtriage.architecture;
...
class DomainPurityArchTest {
    ...
    private static final String DOMAIN_PACKAGE =
            "com.ceticgroup.cloud.nodeprovider.logtriage.domain..";

    private static final JavaClasses PRODUCTION_CLASSES =
            new ClassFileImporter()
                    .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
                    .importPackages("com.ceticgroup.cloud.nodeprovider.logtriage");
    ...
    @Test
    void domain_must_not_depend_on_springAi() {
        ArchRule rule =
                noClasses()
                        .that()
                        .resideInAPackage(DOMAIN_PACKAGE)
    ...
    @Test
    void domain_must_not_depend_on_jgit() {
        ArchRule rule =
                noClasses()
                        .that()
                        .resideInAPackage(DOMAIN_PACKAGE)
    ...
    @Test
    void domain_must_not_depend_on_gitlab4j() {
        ArchRule rule =
                noClasses()
                        .that()
                        .resideInAPackage(DOMAIN_PACKAGE)
                        .should()
                        .dependOnClassesThat()
                        .resideInAnyPackage("org.gitlab4j..");
    ...
    @Test
    void domain_must_not_depend_on_resilience4j() {
        ArchRule rule =
                noClasses()
                        .that()
                        .resideInAPackage(DOMAIN_PACKAGE)
    ...
    @Test
    void domain_must_not_depend_on_micrometer() {
        ArchRule rule =
                noClasses()
                        .that()
                        .resideInAPackage(DOMAIN_PACKAGE)
